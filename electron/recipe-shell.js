'use strict';
/**
 * Shop POS Recipe & Production — live Windows shell.
 * Loads Railway recipe-app so every deploy reaches this PC automatically.
 */
const { app, BrowserWindow, Menu } = require('electron');

const BASE = (process.env.SHOP_POS_SYNC_URL || 'https://chisafood.up.railway.app').replace(/\/$/, '');
const APP_URL = `${BASE}/recipe-app.html`;
...
function offlineHtml() {
  return `<!doctype html>
<html><head><meta charset="utf-8"><title>Recipe & Production</title>
<style>
...
<body><div class="card">
  ...
  <p>This app needs the internet so it can load the latest Recipe &amp; Production changes from your shop.</p>
...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      partition: 'persist:shoppos-recipe'
    }
  });
