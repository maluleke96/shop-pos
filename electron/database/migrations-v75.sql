...
CREATE TABLE IF NOT EXISTS mkt_businesses (
...
CREATE TABLE IF NOT EXISTS mkt_campaigns_v2 (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  uid TEXT UNIQUE,
  business_id INTEGER,
  branch_id INTEGER,
...
CREATE TABLE IF NOT EXISTS mkt_whatsapp_blasts (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  campaign_id INTEGER,
  business_id INTEGER,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mkt_customer_segments (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mkt_loyalty_rules (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mkt_loyalty_accounts (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS mkt_loyalty_transactions (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS mkt_referral_agents (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS mkt_agent_status_history (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS mkt_commission_rules (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mkt_referrals_v2 (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  agent_id INTEGER NOT NULL,
  customer_id INTEGER,
...
CREATE TABLE IF NOT EXISTS mkt_commission_ledger (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS mkt_agent_wallets (
...
CREATE TABLE IF NOT EXISTS mkt_agent_payments (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  agent_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS mkt_contract_templates (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mkt_agent_contracts (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  agent_id INTEGER NOT NULL,
  template_id INTEGER,
  business_id INTEGER,
...
CREATE TABLE IF NOT EXISTS mkt_agent_incentives (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  name TEXT NOT NULL,
  rules_json TEXT DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS mkt_qr_codes (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  branch_id INTEGER,
...
CREATE TABLE IF NOT EXISTS mkt_calendar_events (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  business_id INTEGER,
  branch_id INTEGER,
...
CREATE TABLE IF NOT EXISTS mkt_platform_audit (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  user_id INTEGER,
  user_name TEXT,
  action TEXT NOT NULL,
...
INSERT OR IGNORE INTO mkt_settings (id, default_commission_percent, referral_base_url)
VALUES (1, 5, '/r/');
