...
async function bootRpc() {
  ...
  try {
    require('../electron/services/communication-centre').ensureSchema();
  } catch (e) {
    console.warn('[rpc] communication-centre schema bootstrap:', e.message || e);
  }
  try {
    require('../electron/services/comm-portal').ensurePortalSchema();
  } catch (e) {
    console.warn('[rpc] comm-portal schema bootstrap:', e.message || e);
  }
  try {
    require('../electron/services/comm-portal').ensurePortalSchema();
  } catch (e) {
  ...
  try {
    require('../electron/services/communication-scheduler').startCommunicationScheduler();
  } catch (e) {
    console.warn('[rpc] communication scheduler:', e.message || e);
  }
