...
const API = {
  ...
  recoverReferralAgentPassword: (identifier) => invoke('auth:recoverReferralAgentPassword', identifier),
  resetReferralAgentPassword: (data) => invoke('auth:resetReferralAgentPassword', data || {}),
  recoverAdminPassword: (identifier) => invoke('auth:recoverAdminPassword', identifier),
  ...
  getStockHistory: (productIdOrFilters) => invoke('stock:history', productIdOrFilters),
  ...
  parseExpenseReceipt: (text) => invoke('expenses:parseReceipt', text),
  getExpenseBudgets: (filters) => invoke('expenses:budgets', filters),
  getExpenseBudgetStatus: (monthKey) => invoke('expenses:budgetStatus', monthKey),
  saveExpenseBudget: (data, actor) => invoke('expenses:saveBudget', data, actor),
  deleteExpenseBudget: (id, actor) => invoke('expenses:deleteBudget', id, actor),
  getExpenseRecurring: () => invoke('expenses:recurring'),
  saveExpenseRecurring: (data, actor) => invoke('expenses:saveRecurring', data, actor),
  deleteExpenseRecurring: (id, actor) => invoke('expenses:deleteRecurring', id, actor),
  postExpenseRecurring: (actor) => invoke('expenses:postRecurring', actor),
  getOwnerFundings: (filters) => invoke('expenses:ownerFundings', filters),
  recordOwnerFunding: (data, actor) => invoke('expenses:recordOwnerFunding', data, actor),

  stockBatchDashboard: (f) => invoke('stockBatch:dashboard', f || {}),
  stockBatchList: (f) => invoke('stockBatch:list', f || {}),
  stockBatchGet: (id) => invoke('stockBatch:get', id),
  stockBatchCreate: (data, actor) => invoke('stockBatch:create', data || {}, actor),
  stockBatchUpdate: (id, data, actor) => invoke('stockBatch:update', id, data || {}, actor),
  stockBatchWaste: (id, data, actor) => invoke('stockBatch:waste', id, data || {}, actor),
  stockBatchSetActualYield: (id, yieldVal, actor) => invoke('stockBatch:setActualYield', id, yieldVal, actor),
  stockBatchClose: (id, reason, actor) => invoke('stockBatch:close', id, reason, actor),
  stockBatchReopen: (id, actor) => invoke('stockBatch:reopen', id, actor),
  stockBatchCancel: (id, reason, actor) => invoke('stockBatch:cancel', id, reason, actor),
  stockBatchEvents: (id, limit) => invoke('stockBatch:events', id, limit),
  stockBatchSettings: () => invoke('stockBatch:settings'),
  stockBatchSaveSettings: (data, actor) => invoke('stockBatch:saveSettings', data || {}, actor),
  stockBatchProductAnalysis: (f) => invoke('stockBatch:productAnalysis', f || {}),
  stockBatchProfitability: (f) => invoke('stockBatch:profitability', f || {}),
  ...
  deleteSupplier: (id, actor) => invoke('suppliers:delete', id, actor),
  ...
  getStorageMonitor: (opts, actor) => invoke('db:storageMonitor', opts || {}, actor),
  recordStorageSnapshot: (actor) => invoke('db:storageSnapshot', actor),
  ...
  listTakenOrders: (filters, actor) => invoke('taken:list', filters || {}, actor),
  takenOrdersSummary: (actor) => invoke('taken:summary', actor),
  payTakenOrder: (id, data, actor) => invoke('taken:pay', id, data || {}, actor),
  ...
  listDiscountVouchers: (filters) => invoke('vouchers:list', filters || {}),
  createDiscountVoucher: (data, actor) => invoke('vouchers:create', data, actor),
  validateDiscountVoucher: (code, opts) => invoke('vouchers:validate', code, opts || {}),
  redeemDiscountVoucher: (code, opts, actor) => invoke('vouchers:redeem', code, opts || {}, actor),
  ...
  syncMissingLoyaltyPoints: (actor) => invoke('loyalty:syncMissing', actor),
  listRestorableExpiredPoints: (opts, actor) => invoke('loyalty:listRestorable', opts || {}, actor),
  restoreExpiredLoyaltyPoints: (expireTxnId, actor) => invoke('loyalty:restoreExpired', expireTxnId, actor),
  ...
  releaseTable: (tableId, actor) => invoke('tables:release', tableId, actor),
  ...
  updateSale: (id, patch, actor) => invoke('audit:updateSale', id, patch, actor),
  deleteSale: (id, reason, actor) => invoke('audit:deleteSale', id, reason, actor),
  deleteSalesBulk: (ids, reason, actor) => invoke('audit:deleteSalesBulk', ids, reason, actor),
  ...
  getStaffDocuments: (id, actor) => invoke('staff:getDocuments', id, actor),
  ...
  mgrHrListAssignments: (actor) => invoke('mgrHr:listAssignments', actor),
  mgrHrGetAssignment: (id, actor) => invoke('mgrHr:getAssignment', id, actor),
  mgrHrSaveAssignment: (data, actor) => invoke('mgrHr:saveAssignment', data || {}, actor),
  mgrHrSetAssignmentActive: (id, active, actor) => invoke('mgrHr:setAssignmentActive', id, active, actor),
  mgrHrListEligibleUsers: (actor) => invoke('mgrHr:listEligibleUsers', actor),
  mgrHrListActivity: (filters, actor) => invoke('mgrHr:listActivity', filters || {}, actor),
  mgrHrPortalContext: (actor) => invoke('mgrHr:portalContext', actor),
  mgrHrDashboard: (actor) => invoke('mgrHr:dashboard', actor),
  mgrHrListMyStaff: (actor) => invoke('mgrHr:listMyStaff', actor),
  mgrHrListCases: (filters, actor) => invoke('mgrHr:listCases', filters || {}, actor),
  mgrHrGetCase: (id, actor) => invoke('mgrHr:getCase', id, actor),
  mgrHrCreateCase: (data, actor) => invoke('mgrHr:createCase', data || {}, actor),
  mgrHrUpdateStatus: (id, status, notes, actor) => invoke('mgrHr:updateStatus', id, status, notes, actor),
  mgrHrRequestResponse: (id, notes, actor) => invoke('mgrHr:requestResponse', id, notes, actor),
  mgrHrAddRecommendation: (id, data, actor) => invoke('mgrHr:addRecommendation', id, data || {}, actor),
  mgrHrCreateWarning: (id, data, actor) => invoke('mgrHr:createWarning', id, data || {}, actor),
  mgrHrAdminDecide: (id, data, actor) => invoke('mgrHr:adminDecide', id, data || {}, actor),
  mgrHrDeleteCase: (id, actor) => invoke('mgrHr:deleteCase', id, actor),
  mgrHrListNotifications: (audience, actor) => invoke('mgrHr:listNotifications', audience, actor),
  mgrHrMarkNotificationRead: (id, actor) => invoke('mgrHr:markNotificationRead', id, actor),
  mgrHrListEmployeeCases: (actor) => invoke('mgrHr:listEmployeeCases', actor),
  mgrHrGetEmployeeCase: (id, actor) => invoke('mgrHr:getEmployeeCase', id, actor),
  mgrHrSubmitEmployeeResponse: (id, data, actor) => invoke('mgrHr:submitEmployeeResponse', id, data || {}, actor),
  mgrHrListRecordings: (filters, actor) => invoke('mgrHr:listRecordings', filters || {}, actor),
  mgrHrGetRecording: (id, actor) => invoke('mgrHr:getRecording', id, actor),
  mgrHrCreateRecording: (data, actor) => invoke('mgrHr:createRecording', data || {}, actor),
  mgrHrUpdateRecording: (id, data, actor) => invoke('mgrHr:updateRecording', id, data || {}, actor),
  mgrHrDeleteRecording: (id, actor) => invoke('mgrHr:deleteRecording', id, actor),
  mgrHrAnalyzeRecording: (id, data, actor) => invoke('mgrHr:analyzeRecording', id, data || {}, actor),
  mgrHrRecordingDocumentHtml: (id, actor) => invoke('mgrHr:recordingDocumentHtml', id, actor),
  mgrHrCaseDocumentHtml: (id, actor) => invoke('mgrHr:caseDocumentHtml', id, actor),
  ...
  listLeaseAgreements: (actor) => invoke('hr:listLeases', actor),
  getLeaseAgreement: (id, actor) => invoke('hr:getLease', id, actor),
  saveLeaseAgreement: (data, actor) => invoke('hr:saveLease', data, actor),
  deleteLeaseAgreement: (id, actor) => invoke('hr:deleteLease', id, actor),
  uploadLeaseAgreement: (id, fileName, dataUrl, actor) => invoke('hr:uploadLease', id, fileName, dataUrl, actor),
  getLeasePdf: (id, actor) => invoke('hr:leasePdf', id, actor),
  ...
  getPublicJobPosting: (token) => invoke('jobs:getPublicPosting', token),
  listPublicJobPostings: () => invoke('jobs:listPublicPostings'),
  getPublicJobApplication: (editToken) => invoke('jobs:getPublicApplication', editToken),
  lookupPublicJobApplication: (token, phone) => invoke('jobs:lookupPublicApplication', token, phone),
  submitPublicJobApplication: (token, data) => invoke('jobs:submitPublicApplication', token, data),
  updatePublicJobApplication: (editToken, data) => invoke('jobs:updatePublicApplication', editToken, data),
  deletePublicJobApplication: (editToken) => invoke('jobs:deletePublicApplication', editToken),
  deleteJobCandidate: (id, actor) => invoke('jobs:deleteCandidate', id, actor),
  downloadJobCandidateCv: (id, actor) => invoke('jobs:downloadCv', id, actor),
  getJobPosterPdf: (id, actor) => invoke('jobs:posterPdf', id, actor),
  getJobShareMessage: (id, actor) => invoke('jobs:shareMessage', id, actor),
  previewJobCandidateWhatsApp: (id, messageType, actor) => invoke('jobs:previewWa', id, messageType, actor),
  ...
  saveAdminSignatureData: (dataUrl, actor) => invoke('ops:saveAdminSignatureData', dataUrl, actor),
  getRuleCategories: () => invoke('ops:getRuleCategories'),
  saveRuleCategory: (name, actor) => invoke('ops:saveRuleCategory', name, actor),
  getRuleAcknowledgements: (filters) => invoke('ops:getRuleAcks', filters),
  signCompanyRule: (ruleId, employeeId, signatureData, actor) => invoke('ops:signRule', ruleId, employeeId, signatureData, actor),
  ...
  moMarkIncidentSeen: (id, actor) => invoke('mo:markIncidentSeen', id, actor),
  moReportPdf: (id, actor) => invoke('mo:reportPdf', id, actor),
  moReportPrint: (id, actor) => invoke('mo:reportPrint', id, actor),
  ...
  recipeRestockPreview: (data, actor) => invoke('recipe:restockPreview', data, actor),
  recipeRestockBatchHistory: (filters, actor) => invoke('recipe:restockBatchHistory', filters, actor),
  recipeRestockBatchDetail: (id, actor) => invoke('recipe:restockBatchDetail', id, actor),
  recipeRestockBatchSave: (data, actor) => invoke('recipe:restockBatchSave', data, actor),
  ...
  recipeGetMeal: (id, actor, opts) => invoke('recipe:getMeal', id, actor, opts || { for_editor: true }),
  recipeSaveMeal: (data, actor) => invoke('recipe:saveMeal', data, actor),
  recipeIngredientCatalog: (actor) => invoke('recipe:ingredientCatalog', actor),
  ...
  recipeIngredientGroups: (actor) => invoke('recipe:ingredientGroups', actor),
  recipeIngredientGroup: (id, actor) => invoke('recipe:ingredientGroup', id, actor),
  recipeSaveIngredientGroup: (data, actor) => invoke('recipe:saveIngredientGroup', data, actor),
  recipeDeleteIngredientGroup: (id, actor) => invoke('recipe:deleteIngredientGroup', id, actor),
  recipeExpandIngredientGroups: (ids, actor) => invoke('recipe:expandIngredientGroups', ids, actor),
  ...
  getFirstOnlineGift: (actor) => invoke('firstOnlineGift:get', actor),
  saveFirstOnlineGift: (data, actor) => invoke('firstOnlineGift:save', data, actor),
  getFirstOnlineGiftDashboard: (filters, actor) => invoke('firstOnlineGift:dashboard', filters, actor),
  listFirstOnlineGiftWinners: (filters, actor) => invoke('firstOnlineGift:winners', filters, actor),
  selfTestFirstOnlineGift: (actor) => invoke('firstOnlineGift:selfTest', actor),

  listPaymentGateways: (actor) => invoke('paymentGateways:list', actor),
  savePaymentGateway: (provider, data, actor) => invoke('paymentGateways:save', provider, data, actor),
  testPaymentGateway: (provider, actor) => invoke('paymentGateways:test', provider, actor),
  registerPaymentGatewayWebhook: (provider, actor) => invoke('paymentGateways:registerWebhook', provider, actor),
  listPaymentTransactions: (filters, actor) => invoke('paymentGateways:listTransactions', filters, actor),
  refundPaymentTransaction: (txnId, amount, actor) => invoke('paymentGateways:refund', txnId, amount, actor),
  ...
  deleteBranch: (branchId, actor) => invokeCloudFirst('branches:delete', [branchId, actor], () => invoke('branches:delete', branchId, actor)),
  listBranchTills: (branchId) => invokeCloudFirst('branches:listTills', [branchId], () => invoke('branches:listTills', branchId)),
  saveBranchTill: (branchId, data, actor) => invokeCloudFirst('branches:saveTill', [branchId, data || {}, actor], () => invoke('branches:saveTill', branchId, data, actor)),
  updateBranchTill: (branchId, deviceId, patch, actor) => invokeCloudFirst('branches:updateTill', [branchId, deviceId, patch || {}, actor], () => invoke('branches:updateTill', branchId, deviceId, patch, actor)),
  deleteBranchTill: (branchId, deviceId, actor) => invokeCloudFirst('branches:deleteTill', [branchId, deviceId, actor], () => invoke('branches:deleteTill', branchId, deviceId, actor)),
  posHeartbeat: (branchId, deviceId, label) => invokeCloudFirst('mobile:heartbeat', [branchId, deviceId, label], () => invoke('mobile:heartbeat', branchId, deviceId, label)),
  ...
  // Referral & Commission
  referralDashboard: (filters, actor) => invoke('referral:dashboard', filters || {}, actor),
  referralApplications: (filters, actor) => invoke('referral:applications', filters || {}, actor),
  referralGetAgent: (id, actor, opts) => invoke('referral:getAgent', id, actor, opts || {}),
  referralApproveAgent: (id, actor, opts) => invoke('referral:approveAgent', id, actor, opts || {}),
  referralRejectAgent: (id, reason, actor) => invoke('referral:rejectAgent', id, reason, actor),
  referralUnderReview: (id, actor) => invoke('referral:underReview', id, actor),
  referralSuspendAgent: (id, actor) => invoke('referral:suspendAgent', id, actor),
  ...
  referralDecideAwardRequest: (id, data, actor) => invoke('referral:decideAwardRequest', id, data || {}, actor),
  referralSearchCodes: (q) => invoke('referral:searchCodes', q),
  referralAgents: (filters, actor) => invoke('referral:agents', filters || {}, actor),
  referralCommissions: (filters, actor) => invoke('referral:commissions', filters || {}, actor),
  referralApproveCommission: (id, actor) => invoke('referral:approveCommission', id, actor),
  referralMarkAvailable: (actor) => invoke('referral:markAvailable', actor),
  referralPayouts: (filters, actor) => invoke('referral:payouts', filters || {}, actor),
  referralGetPayout: (id, actor) => invoke('referral:getPayout', id, actor),
  referralGeneratePayout: (data, actor) => invoke('referral:generatePayout', data || {}, actor),
  referralApprovePayout: (id, actor) => invoke('referral:approvePayout', id, actor),
  referralMarkPayoutPaid: (id, data, actor) => invoke('referral:markPayoutPaid', id, data || {}, actor),
  referralClaimWallet: (actor) => invoke('referral:claimWallet', actor),
  referralGetPayslip: (id, actor) => invoke('referral:getPayslip', id, actor),
  referralSettings: (actor) => invoke('referral:settings', actor),
  referralUpdateSettings: (data, actor) => invoke('referral:updateSettings', data || {}, actor),
  referralAttributions: (filters, actor) => invoke('referral:attributions', filters || {}, actor),
  referralCodes: (actor) => invoke('referral:codes', actor),
  referralTopAgents: (filters, actor) => invoke('referral:topAgents', filters || {}, actor),
  referralAudit: (filters, actor) => invoke('referral:audit', filters || {}, actor),
  referralFraud: (actor) => invoke('referral:fraud', actor),
  referralApproveBankChange: (id, actor) => invoke('referral:approveBankChange', id, actor),
  referralApply: (data) => invoke('referral:apply', data || {}),
  referralAgentDashboard: (actor) => invoke('referral:agentDashboard', actor),
  referralUnreadNotifications: (filters, actor) => invoke('referral:unreadNotifications', filters || {}, actor),
  referralAckNotification: (id, meta, actor) => invoke('referral:ackNotification', id, meta || {}, actor),
  referralAckAllNotifications: (filters, actor) => invoke('referral:ackAllNotifications', filters || {}, actor),
  referralRequestBankChange: (data, actor) => invoke('referral:requestBankChange', data || {}, actor),
  referralValidateCode: (code) => invoke('referral:validateCode', code),
  referralRecordClick: (code, meta) => invoke('referral:recordClick', code, meta || {}),
  referralAttribute: (data, actor) => invoke('referral:attribute', data || {}, actor),
  referralResetAgentPassword: (id, actor, opts) => invoke('referral:resetAgentPassword', id, actor, opts || {}),
  referralEnsureAgentLogin: (id, actor) => invoke('referral:ensureAgentLogin', id, actor),
  ...
  webSubmitIssue: (data, token) => invoke('web:submitIssue', data, token),
  webListMyIssues: (token) => invoke('web:listMyIssues', token),
  webListIssues: (filters, actor) => invoke('web:listIssues', filters, actor),
  webGetIssue: (id, actor) => invoke('web:getIssue', id, actor),
  webReplyIssue: (id, reply, actor) => invoke('web:replyIssue', id, reply, actor),
  ...
  webAdminOrderDetail: (orderId, actor) => invokeCloudFirst('web:adminOrderDetail', [orderId, actor], () => invoke('web:adminOrderDetail', orderId, actor)),
  webAdminUpdateOrder: (orderId, patch, actor) => invokeCloudFirst('web:adminUpdateOrder', [orderId, patch, actor], () => invoke('web:adminUpdateOrder', orderId, patch, actor)),
  webAdminDeleteOrder: (orderId, reason, actor) => invokeCloudFirst('web:adminDeleteOrder', [orderId, reason, actor], () => invoke('web:adminDeleteOrder', orderId, reason, actor)),
  ...
  webVisitorDashboard: (filters, actor) => invokeCloudFirst('web:visitorDashboard', [filters || {}, actor], () => invoke('web:visitorDashboard', filters, actor)),
  webOnlineCustomers: (filters, actor) => invokeCloudFirst('web:onlineCustomers', [filters || {}, actor], () => invoke('web:onlineCustomers', filters, actor)),
  ...
  signageLoginAsAdmin: (actor) => invoke('signage:loginAsAdmin', actor),
  signagePendingPairingsAdmin: (actor) => invoke('signage:pendingPairingsAdmin', actor),
  signageApprovePairingAdmin: (code, data, actor) => invoke('signage:approvePairingAdmin', code, data, actor),
  ...
  radioAdminOverview: (actor) => invoke('radio:adminOverview', actor),
  radioAdminSaveSettings: (data, actor) => invoke('radio:adminSaveSettings', data, actor),

  // Communication Center
  ccDashboard: (actor) => invoke('cc:dashboard', actor),
  ccHistory: (filters, actor) => invoke('cc:history', filters || {}, actor),
  ccFailed: (actor) => invoke('cc:failed', actor),
  ccScheduled: (actor) => invoke('cc:scheduled', actor),
  ccRetry: (id, actor) => invoke('cc:retry', id, actor),
  ccCancel: (id, actor) => invoke('cc:cancel', id, actor),
  ccSendNow: (id, actor) => invoke('cc:sendNow', id, actor),
  ccCreateMessage: (data, actor) => invoke('cc:createMessage', data || {}, actor),
  ccSharePublish: (data, actor) => invoke('cc:sharePublish', data || {}, actor),
  ccPreviewAudience: (audience, actor) => invoke('cc:previewAudience', audience || {}, actor),
  ccTemplates: (actor) => invoke('cc:templates', actor),
  ccSaveTemplate: (data, actor) => invoke('cc:saveTemplate', data || {}, actor),
  ccEventTypes: (actor) => invoke('cc:eventTypes', actor),
  ccSaveEventType: (data, actor) => invoke('cc:saveEventType', data || {}, actor),
  ccAutomations: (actor) => invoke('cc:automations', actor),
  ccSaveAutomation: (data, actor) => invoke('cc:saveAutomation', data || {}, actor),
  ccSetAutomationEnabled: (id, enabled, actor) => invoke('cc:setAutomationEnabled', id, enabled, actor),
  ccCampaigns: (actor) => invoke('cc:campaigns', actor),
  ccConnections: (actor) => invoke('cc:connections', actor),
  ccSaveConnection: (data, actor) => invoke('cc:saveConnection', data || {}, actor),
  ccMedia: (actor) => invoke('cc:media', actor),
  ccSettings: (actor) => invoke('cc:settings', actor),
  ccSaveSettings: (data, actor) => invoke('cc:saveSettings', data || {}, actor),
  ccBranches: (actor) => invoke('cc:branches', actor),
  ccSaveBranch: (data, actor) => invoke('cc:saveBranch', data || {}, actor),
  ccProcessQueue: (actor) => invoke('cc:processQueue', actor)
};
