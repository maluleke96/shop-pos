-- Shop POS COMPLETE_SUPABASE_SETUP.sql — paste into Supabase SQL Editor
-- SAFE: CREATE IF NOT EXISTS / additive. No DROP/TRUNCATE of business data.
-- Data import is separate. See EXECUTION_ORDER.md

-- >>>>>> BEGIN 00_extensions.sql <<<<<<
-- Shop POS â†’ Supabase: extensions (run first)
-- SAFE: CREATE EXTENSION IF NOT EXISTS only
...
-- >>>>>> BEGIN 01_schema.sql <<<<<<
-- AUTO-GENERATED from live SQLite â€” Shop POS â†’ Supabase Postgres
...
-- Archived (online ordering / hub sync removed from product): online_orders_local â†’ legacy_online_orders_local
...
-- Archived (online ordering / hub sync removed from product): sync_outbox â†’ legacy_sync_outbox
...
-- >>>>>> BEGIN 02_auth_and_profiles.sql <<<<<<
-- Shop POS â†’ Supabase: Auth bridge (profiles) + helper functions
-- SAFE: no DROP of legacy public.users â€” keep for SQLite data import
--
...
-- >>>>>> END 02_auth_and_profiles.sql <<<<<<

-- >>>>>> BEGIN 03_functions_triggers.sql <<<<<<
-- Shop POS â†’ Supabase: shared functions and updated_at triggers
...
-- >>>>>> END 03_functions_triggers.sql <<<<<<

-- >>>>>> BEGIN 04_rls.sql <<<<<<
-- Shop POS â†’ Supabase: Row Level Security
...
-- ===========================================================================
-- shop_settings â€” management only
-- ===========================================================================
...
-- ===========================================================================
-- legacy users â€” owner/manager read; owner write
-- ===========================================================================
...
-- ===========================================================================
-- categories & products â€” all staff read; management write
-- ===========================================================================
...
-- ===========================================================================
-- sales pipeline â€” cashiers insert; management full access
-- ===========================================================================
...
-- ===========================================================================
-- customers & suppliers â€” management full; cashiers read customers
-- ===========================================================================
...
-- >>>>>> BEGIN 05_storage.sql <<<<<<
-- Shop POS â†’ Supabase: Storage buckets and object policies
-- SAFE: INSERT buckets on conflict skip; idempotent policies

-- ---------------------------------------------------------------------------
-- Buckets
-- logos, products â†’ public read; all others private
-- ---------------------------------------------------------------------------
...
-- >>>>>> BEGIN 06_realtime.sql <<<<<<
-- Shop POS â†’ Supabase: Realtime publication
