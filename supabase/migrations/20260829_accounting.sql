-- Central accounting ledger (Postgres)
...
CREATE TABLE IF NOT EXISTS acc_settings (
  ...
  approval_expense_threshold DOUBLE PRECISION DEFAULT 5000,
  approval_payment_threshold DOUBLE PRECISION DEFAULT 10000,
...
CREATE TABLE IF NOT EXISTS acc_cashup_finance (
  ...
  expected_card DOUBLE PRECISION DEFAULT 0,
  expected_eft DOUBLE PRECISION DEFAULT 0,
  actual_cash DOUBLE PRECISION DEFAULT 0,
  actual_card DOUBLE PRECISION DEFAULT 0,
  actual_eft DOUBLE PRECISION DEFAULT 0,
...
INSERT INTO acc_tax_rates (id, name, rate, tax_type, is_default, is_active)
VALUES (1, 'VAT Standard', 15, 'vat', 1, 1);

-- Seed Chart of Accounts
INSERT INTO acc_accounts (id, code, name, type, subtype, is_system) VALUES
...
INSERT INTO acc_bank_accounts (id, name, bank_name, gl_account_id, opening_balance)
VALUES (1, 'Main Business Account', 'Primary Bank', 3, 0) ON CONFLICT (id) DO NOTHING;

INSERT INTO acc_cash_accounts (id, name, gl_account_id, is_petty, opening_balance)
VALUES (1, 'Till Cash', 1, 0, 0), (2, 'Petty Cash', 2, 1, 0) ON CONFLICT (id) DO NOTHING;

-- Current fiscal year period
INSERT INTO acc_periods (id, name, start_date, end_date, status)
VALUES (1, 'Current Year', date_trunc('year', CURRENT_DATE)::date, (date_trunc('year', CURRENT_DATE) + INTERVAL '1 year' - INTERVAL '1 day')::date, 'open');
