...
const majors = [
  ...
  M({ id: 'mod.manager_operations', kind: 'major', name: 'Manager Operations & Daily Tasks', description: 'Mobile manager daily duties, role-based checklists, photo evidence, incidents, sales monitoring from POS, and daily reports to the owner.', appears_in: ['/manager-ops/', 'Admin manager-ops', 'Platform Control modules'], admin_menu: 'manager-ops', related_apis: ['mo:*', 'managerOps:*'], database_tables: ['mo_*'], related_jobs: ['daily task generation from operating hours'], dependencies: ['app.admin', 'app.pos', 'core.users_permissions', 'core.sync_notify'], sellable_addon: true, notes: 'Alias manager_operations. Disabling never deletes mo_* history.' }),
...
const adminSections = [
  ...
  ['manager-ops', 'Manager Operations', 'Daily tasks, checklists, reports, evidence.', 'mod.manager_operations', true],
